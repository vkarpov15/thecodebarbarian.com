...
module.exports = [
  ...
  {
    src: './lib/posts/20231031_astra_vector_search.md',
    dest: {
      directory: './bin',
      name: 'rag-vector-search-with-astra-and-mongoose'
    },
    title: 'Retrieval Augmented Generation with Astra and Mongoose',
    date: moment('2023-10-31'),
    tags: ['NodeJS'],
    previewText: 'A brief introduction to vector search with retrieval augmented generation using Astra DB and Mongoose, including maximal marginal relevance (MMR).',
    image: 'https://images.unsplash.com/photo-1465343161283-c1959138ddaa?auto=format&fit=crop&q=80&w=710&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
  }
