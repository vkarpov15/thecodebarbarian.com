...
module.exports = [
  ...
  {
    src: './lib/posts/20250527_astra_mongoose.md',
    dest: {
      directory: './bin',
      name: 'introducing-astra-mongoose'
    },
    title: 'Introducing @datastax/astra-mongoose: The New Way to Use DataStax Astra with Mongoose',
    date: moment('2025-05-27'),
    tags: ['NodeJS'],
    previewText: 'DataStax\'s new @datastax/astra-mongoose package lets you use the familiar Mongoose ODM with Cassandra databases. This 1.0 release builds on our previous stargate-mongoose work but with improved connectivity through the official Astra DB driver, better TypeScript support, and enhanced support for Cassandra tables.',
    image: 'https://codebarbarian-images.s3.us-east-1.amazonaws.com/ChatGPT+Image+May+21%2C+2025%2C+10_46_33+AM.png'
  },
  {
    src: './lib/posts/20251106_mongoose_studio.md',
    dest: {
      directory: './bin',
      name: 'introducing-mongoose-studio-a-better-way-to-work-with-mongodb'
    },
    title: 'Introducing Mongoose Studio: A Better Way to Work with MongoDB',
    date: moment('2025-11-06'),
    tags: ['NodeJS'],
    previewText: 'We built Mongoose Studio to make that whole experience smoother. It’s a MongoDB UI and dashboard layer that runs alongside your Node.js app - whether that’s Express, Vercel, or Netlify - using the same Mongoose connection config you already have.',
    image: 'https://res.cloudinary.com/drfhhq8wu/image/upload/w_357/v1759347701/images/6893649a6600d6325786740a/augmented-temp-1759347699298-1759347699298.png.webp'
  },
  {
    src: './lib/posts/20251118_mongodb_tries.md',
    dest: {
      directory: './bin',
      name: 'using-tries-to-autocomplete-mongodb-queries-in-nodejs'
    },
    title: 'Using Tries to Autocomplete MongoDB Queries in Node.js',
    date: moment('2025-11-18'),
    tags: ['NodeJS', 'MongoDB'],
    previewText: 'This post explains how you can use tries to autocomplete MongoDB queries in Node.js, and how you can use tries for autocomplete in Node.js in general.',
    image: 'https://i.imgur.com/iE6ZfGP.jpeg'
  },
  {
    src: './lib/posts/20251212_mongoose_9.md',
    dest: {
      directory: './bin',
      name: 'mongoose-9-async-stack-traces-cleaner-middleware-stricter-typescript'
    },
    title: 'Mongoose 9.0: Async Stack Traces, Cleaner Middleware, Stricter TypeScript',
    date: moment('2025-12-12'),
    tags: ['NodeJS', 'MongoDB'],
    previewText: 'Mongoose 9 delivers a long-awaited overhaul to async stack traces, so you finally see where errors really happen, even across awaits. Async-only middleware, safer defaults, and improved TypeScript precision.',
    image: 'https://res.cloudinary.com/drfhhq8wu/image/upload/w_357/v1765142460/mongoose-christmas_u1sby4.webp'
  },
  {
    src: './lib/posts/20260223_ai_sdk.md',
    dest: {
      directory: './bin',
      name: 'getting-started-with-the-vercel-ai-sdk-in-nodejs'
    },
    title: 'Getting Started with the Vercel AI SDK in Node.js',
    date: moment('2026-02-23'),
    tags: ['NodeJS'],
    previewText: 'Learn the Vercel AI SDK essentials in Node.js: set up providers, stream model output, use tools, and ship chat-style AI features quickly.',
    image: 'https://res.cloudinary.com/drfhhq8wu/image/upload/w_357/v1771883888/ai-vibes-1.webp'
  },
  {
    src: './lib/posts/20260327_ai_sdk_agents.md',
    dest: {
      directory: './bin',
      name: 'getting-started-with-the-vercel-ai-sdk-agents-in-nodejs'
    },
    title: 'Getting Started with the Vercel AI SDK Agents in Node.js',
    date: moment('2026-03-27'),
    tags: ['NodeJS'],
    previewText: 'Learn how to build a basic AI agent using the Vercel AI SDK in Node.js.',
    image: 'https://res.cloudinary.com/drfhhq8wu/image/upload/w_357/v1771346730/ai-vibes-2_qa09zq.webp'
  },
  {
    src: './lib/posts/20260527_mongoose_96.md',
    dest: {
      directory: './bin',
      name: 'mongoose-96-allownull'
    },
    title: 'What\'s New in Mongoose 9.6: The allowNull Option',
    date: moment('2026-05-27'),
    tags: ['NodeJS', 'MongoDB'],
    previewText: 'Mongoose 9.6 adds a new allowNull schema type option that lets you disallow null without making a path required.',
    image: 'https://res.cloudinary.com/drfhhq8wu/image/upload/w_357/v1779895179/99ae1534-5f9e-4bbe-9a8a-9bdb80394b24_expdc9.webp'
  },
  {
    src: './lib/posts/20260713_mongoose_studio_sse.md',
    dest: {
      directory: './bin',
      name: 'mongoose-studio-sse'
    },
    title: 'Streaming Documents to the Frontend with SSE in Mongoose Studio',
    date: moment('2026-07-13'),
    tags: ['NodeJS', 'MongoDB'],
    previewText: 'Mongoose Studio streams query results to the frontend using Server-Sent Events (SSE) - much faster for slow queries than pagination. Here\'s how it works.',
    image: 'https://res.cloudinary.com/drfhhq8wu/image/upload/w_357/v1783808357/terraveratest/production-orders/PO-0001/PO-0001-1783808357529.webp'
  },
  {
    src: './lib/posts/20260729_mongoose_studio_data_api.md',
    dest: {
      directory: './bin',
      name: 'mongoose-studio-cassandra-data-api'
    },
    title: 'Using Mongoose Studio with Apache Cassandra via Data API',
    date: moment('2026-07-29'),
    tags: ['NodeJS'],
    previewText: 'We built a plugin to allow Mongoose Studio to connect to Apache Cassandra via DataStax\' Data API, here\'s how it works.',
    image: 'https://res.cloudinary.com/drfhhq8wu/image/upload/w_357/v1761063351/images/6893649a6600d6325786740a/augmented-68dd85e39d7b5651f5e756d4-1761063349696.webp'
  },
  {
    src: './lib/posts/20260731_mongoose_99_perf.md',
    dest: {
      directory: './bin',
      name: 'mongoose-99-perf'
    },
    title: 'What\'s New in Mongoose 9.9: Major Performance Improvements',
    date: moment('2026-07-31'),
    tags: ['NodeJS', 'MongoDB'],
    previewText: 'Mongoose 9.9 introduces major performance improvements, including a 40% speedup to insertMany() and change tracking improvements that can make save() 10% faster as well.',
    image: 'https://r2-prod.terravera-static.uk/valtest/Mongoose_Perf_rvnxnx.webp'
  },
  {
    src: './lib/posts/20260921_sse_yield_star.md',
    dest: {
      directory: './bin',
      name: 'sse-yield-star'
    },
    title: 'Faster SSE Responses with Async Generators and Promise.race()',
    date: moment('2026-09-21'),
    tags: ['NodeJS', 'MongoDB'],
    previewText: 'Server-sent events (SSE) allows you to send data to the frontend as soon as it is ready, which makes `Promise.all()` a suboptimal pattern. In this blog post, I\'ll describe a better pattern that yields results as soon as they are ready.',
    image: 'https://plus.unsplash.com/premium_photo-1684522168034-32f22b4b7eef?q=80&w=1332&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
  }
